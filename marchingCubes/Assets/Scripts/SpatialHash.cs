...
public class SpatialHash<T>
{
    ...
    private const int BIG_ENOUGH_INGameObject = 16 * 1024;
    private const double BIG_ENOUGH_FLOOR = BIG_ENOUGH_INGameObject + 0.0000;

    private static int FastFloor(float f)
    {
        return (int)(f + BIG_ENOUGH_FLOOR) - BIG_ENOUGH_INGameObject;
    }
